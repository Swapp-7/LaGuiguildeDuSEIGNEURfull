...
final class CharacterController extends AbstractController
{
    ...
    #[Route('/life/{reqHP}', name: 'app_character_most_hp', methods: ['GET'])]
    public function mostHp(CharacterRepository $characterRepository, int $reqHP): Response
    {
        $characters = array_filter(
            $characterRepository->findAll(),
            fn(Character $c) => $c->getLife() > $reqHP
        );
